...
from utils_all_data import plotLearning
...
if __name__ =='__main__':
    ...
    agent = Agent(gamma=0.95, epsilon=1.0, lr=lr, input_dims=env.observation_space,
    ...
    plotLearning(x, score_history, eps_history, figure_file, best_data_rate, best_Transmission_delay, best_power_consumption) #畫圖
